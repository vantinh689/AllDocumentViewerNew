...
class HorizontalCarouselRecyclerView(
    ...
    private val activeColor by lazy { ContextCompat.getColor(context, R.color.primaryColor) }
    private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.secondaryColor) }
