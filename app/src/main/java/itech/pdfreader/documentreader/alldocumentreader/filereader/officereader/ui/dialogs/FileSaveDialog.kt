...
import itech.pdfreader.documentreader.alldocumentreader.filereader.officereader.databinding.DialogFileSaveBinding
...
class FileSaveDialog(
    ...
    var binding: DialogFileSaveBinding
    ...
    init {
        ...
        binding =
            DialogFileSaveBinding.inflate(context.getSystemService(Context.LAYOUT_INFLATER_SERVICE) as LayoutInflater)
        ...
        binding.processBtn.setOnClickListener {
            if (binding.fileNameEditText.text.toString().isNotEmpty()) {
                val newName = if (type == Constants.RENAME) {
                    ...
                    if (!binding.fileNameEditText.text.toString().contains(Constants.PDF))
                        binding.fileNameEditText.text.toString() + Constants.PDF
                    else
                        binding.fileNameEditText.text.toString()
                }
