...
import com.reader.office.fc.hpsf.DocumentSummaryInformation;
import com.reader.office.fc.hpsf.MutablePropertySet;
import com.reader.office.fc.hpsf.PropertySet;
import com.reader.office.fc.hpsf.PropertySetFactory;
import com.reader.office.fc.hpsf.SummaryInformation;
...
import com.reader.office.fc.poifs.filesystem.Entry;
import com.reader.office.fc.poifs.filesystem.NPOIFSFileSystem;
...
import com.reader.office.fc.util.POIUtils;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(com.reader.office.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(com.reader.office.fc.hpsf.WritingNotSupportedException wnse)
        {
