...
import com.reader.office.fc.hwpf.model.ListFormatOverride;
import com.reader.office.fc.hwpf.model.ListTables;
import com.reader.office.fc.hwpf.model.POIListData;
import com.reader.office.fc.hwpf.model.POIListLevel;
import com.reader.office.fc.hwpf.model.PicturesTable;
import com.reader.office.fc.hwpf.usermodel.Bookmarks;
import com.reader.office.fc.hwpf.usermodel.BorderCode;
import com.reader.office.fc.hwpf.usermodel.CharacterRun;
import com.reader.office.fc.hwpf.usermodel.Field;
import com.reader.office.fc.hwpf.usermodel.HWPFAutoShape;
import com.reader.office.fc.hwpf.usermodel.HWPFShape;
import com.reader.office.fc.hwpf.usermodel.HWPFShapeGroup;
import com.reader.office.fc.hwpf.usermodel.HeaderStories;
import com.reader.office.fc.hwpf.usermodel.InlineWordArt;
import com.reader.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.reader.office.fc.hwpf.usermodel.OfficeDrawing;
import com.reader.office.fc.hwpf.usermodel.OfficeDrawings;
import com.reader.office.fc.hwpf.usermodel.POIBookmark;
...
import com.reader.office.fc.hwpf.usermodel.Section;
import com.reader.office.fc.hwpf.usermodel.Table;
import com.reader.office.fc.hwpf.usermodel.TableCell;
import com.reader.office.fc.hwpf.usermodel.TableRow;
import com.reader.office.fc.util.LittleEndian;
import com.reader.office.java.awt.Rectangle;
import com.reader.office.java.util.Arrays;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.reader.office.java.awt.Color fillColor = shape.getForegroundColor();
            	com.reader.office.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            // 字符颜色
            com.reader.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.reader.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
