...
public final class AutoShapes
{
     ...
     *
    */
    public static com.reader.office.java.awt.Shape transform(com.reader.office.java.awt.Shape outline, Rectangle2D anchor)
    {
    ...
    static
    {
        ...
        {
            public com.reader.office.java.awt.Shape getOutline(Shape shape)
            {
