...
public final class Slide extends Sheet
{
     ...
     */
    public Slide(com.reader.office.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    */
    ...
    {
        super(new com.reader.office.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    * @see com.reader.office.fc.hslf.usermodel.SlideShow#reorderSlide(int, int)
    */
     ...
     */
    public com.reader.office.fc.hslf.record.Slide getSlideRecord()
    {
        return (com.reader.office.fc.hslf.record.Slide)getSheetContainer();
    }
