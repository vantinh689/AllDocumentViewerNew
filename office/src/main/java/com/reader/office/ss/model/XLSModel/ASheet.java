...
import com.reader.office.constant.SSConstant;
...
import com.reader.office.fc.hssf.usermodel.HSSFAutoShape;
import com.reader.office.fc.hssf.usermodel.HSSFChart;
import com.reader.office.fc.hssf.usermodel.HSSFChildAnchor;
import com.reader.office.fc.hssf.usermodel.HSSFClientAnchor;
import com.reader.office.fc.hssf.usermodel.HSSFFreeform;
import com.reader.office.fc.hssf.usermodel.HSSFLine;
import com.reader.office.fc.hssf.usermodel.HSSFPatriarch;
import com.reader.office.fc.hssf.usermodel.HSSFPicture;
import com.reader.office.fc.hssf.usermodel.HSSFPictureData;
...
import com.reader.office.fc.xls.ChartConverter;
...
import com.reader.office.ss.model.drawing.AnchorPoint;
import com.reader.office.ss.model.drawing.CellAnchor;
import com.reader.office.ss.model.sheetProperty.PaneInformation;
...
import com.reader.office.thirdpart.achartengine.chart.RoundChart;
import com.reader.office.thirdpart.achartengine.chart.XYChart;
 ...
 * <p>
 */
public class ASheet extends Sheet implements com.reader.office.fc.ss.usermodel.Sheet
{
    ...
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.reader.office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.reader.office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.reader.office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.reader.office.ss.model.sheetProperty.ColumnInfo columnInfo = new com.reader.office.ss.model.sheetProperty.ColumnInfo(
