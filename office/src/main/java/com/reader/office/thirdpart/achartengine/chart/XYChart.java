...
import com.reader.office.thirdpart.achartengine.renderers.XYMultipleSeriesRenderer.Orientation;
...
public abstract class XYChart extends AbstractChart {
   ...
   * 
   *(non-Javadoc)
   * @see com.reader.office.thirdpart.achartengine.chart.AbstractChart#setZoomRate(float)
   *
   */
  @Override
